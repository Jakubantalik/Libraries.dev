...
| [Bot avatars](packages/bot-avatars) | Animated bot avatars with living faces — fourteen glossy shapes, four states, for AI agents | `npm install bot-avatars` | [libraries.dev/avatars](https://libraries.dev/avatars) |
