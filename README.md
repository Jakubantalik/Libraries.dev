...
| [Voice](packages/voice-glow) (`voice-glow`) — sound-reactive bottom-edge glow | `npm install voice-glow` | Studio bench: `/studio/app.html#voice` |
...
npm run build:gooey
npm run build:orbs
npm run build:voice             # voice-glow (the home site's Studio imports its dist)
