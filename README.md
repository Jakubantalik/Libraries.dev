...
| [Bot avatars](packages/bot-avatars) | Animated bot avatars with living faces — fifteen glossy shapes, four states, for AI agents | `npm install bot-avatars` | [libraries.dev/avatars](https://libraries.dev/avatars) |
