...
function RecordingPill({ running, paused, resetKey }: { running: boolean; paused: boolean; resetKey: number }) {
...
function BlurWords({ words, stagger, className }: { words: string[]; stagger: boolean; className: string }) {
...
const DEMO_TRANSCRIPT = "Set a timer for ten minutes and remind me to water the plants".split(" ");
...
function PhoneScreen({ promptKey, transcript }: { promptKey: number; transcript: string[] }) {
      ...
      <ControlsPanel library="Voice">
        ...
        {isMic && (
          <div className="pg-field">
            ...
            />
            <span style={{ display: "block", fontSize: 12, opacity: 0.7, marginTop: 6 }}>
