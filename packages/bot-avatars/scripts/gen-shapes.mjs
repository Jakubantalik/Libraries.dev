...
/* Robot: a domed helmet with two ear pods, as three subpaths of one
   outline. */
const robot = "M16 58C16 33.7 31.2 14 50 14C68.8 14 84 33.7 84 58V70C84 81.05 75.05 90 64 90H36C24.95 90 16 81.05 16 70Z" +
  "M5 52C5 48.7 7.7 46 11 46H17V78H11C7.7 78 5 75.3 5 72Z" +
  "M83 46H89C92.3 46 95 48.7 95 52V72C95 75.3 92.3 78 89 78H83Z";
...
/* Slime: a blob that has settled on the ground, with a drip. */
const slime = "M20 80C12 80 12 74 13 66C15 40 30 20 50 20C70 20 85 40 87 66C88 72 88 78 84 80C84.5 84 86 87 86 90.5A4.75 4.75 0 1 1 76.5 90.5C76.5 87 78 84 77.5 80Z";
...
const shapes = { clover, flower, triangle: tri, square, blob: blobShape, ghost, circle, drop, star, robot, droid, mech, alien, hexagon, slime, cat };
