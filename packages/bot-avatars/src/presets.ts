...
export const botAvatarPresets: Record<BotAvatarType, BotAvatarPreset> = {
  clover: { label: 'Clover', color: '#4D7CFF', face: 'eyes', faceX: 50, faceY: 50, faceScale: 1 },
  flower: { label: 'Flower', color: '#FF7AB8', face: 'eyes', faceX: 50, faceY: 51, faceScale: 0.95 },
  triangle: { label: 'Triangle', color: '#FF6B3D', face: 'eyes', faceX: 50, faceY: 61, faceScale: 0.9 },
  ...
  star: { label: 'Star', color: '#FF5A5F', face: 'eyes', faceX: 50, faceY: 52, faceScale: 0.82 },
};
